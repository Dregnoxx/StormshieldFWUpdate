...
ADD-content -path $logfile -value "------------------------------------------"
C:\YOURROOTFOLDER\WinSCP.com /command "open $WSCPLogin@$IPSSH -certificate=*" "put C:\YOURROOTFOLDER\FichierMAJ\LATESTSN200.maj /usr/Firewall/Update/" "exit" | Out-File $fichierlog -Append -encoding UTF8
ADD-content -path $logfile -value ""
